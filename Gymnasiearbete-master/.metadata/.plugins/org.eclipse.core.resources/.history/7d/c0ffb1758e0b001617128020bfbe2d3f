...
public class Player extends Mob{
	...
	public AudioHandler collision = new AudioHandler("audio/wallcollision.wav");
	public AudioHandler hit = new AudioHandler("audio/hit.wav");
	public AudioHandler theme = new AudioHandler("audio/mainthemea.wav");
	public AudioHandler heartbeat = new AudioHandler("audio/heartbeat.wav");
